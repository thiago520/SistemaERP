 ...
 * @author Thiago
 */
public class FrmEtiquetasCardapio extends javax.swing.JFrame {
    ConectaBanco conecta = new ConectaBanco();
    
    public FrmEtiquetasCardapio() {
        initComponents();
        conecta.conexao();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEtiquetasCardapio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmEtiquetasCardapio().setVisible(true);
            }
        });
    }
