 ...
 * @author Thiago
 */
public class FrmRelCardapioSemanal extends javax.swing.JFrame {
    ConectaBanco conecta = new ConectaBanco();

    public FrmRelCardapioSemanal() {
        initComponents();
        conecta.conexao();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRelCardapioSemanal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRelCardapioSemanal().setVisible(true);
            }
        });
    }
