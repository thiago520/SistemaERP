 ...
 * @author Thiago
 */
public class FrmCardapioHoje extends javax.swing.JFrame {
    ConectaBanco conecta = new ConectaBanco();  
  
    
    public FrmCardapioHoje() {
        initComponents();
        conecta.conexao();        
        ...
        try {
           ...
           btnColor.setBackground(corRGB);          
            ...
            Logger.getLogger(FrmCardapioHoje.class.getName()).log(Level.SEVERE, null, ex);
        }      
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCardapioHoje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCardapioHoje().setVisible(true);
            }
        });
    }
